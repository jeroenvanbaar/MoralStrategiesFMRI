...
n_trials = int(sys.argv[4]) # The first n trials on which to fit the model
...
if not os.path.exists(folder):
    os.makedirs(folder)
results.to_csv('%s/Results_sub-%03d_first-%i-trials.csv'%(folder,sub,n_trials))